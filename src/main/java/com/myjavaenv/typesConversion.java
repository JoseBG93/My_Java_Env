...
public class typesConversion {
    public static void main(String[] args) {
        ...
        // Adding the numbers - double is explicitly converted to int
        // Java performs explicit type conversion (narrowing) here:
        // 1. number2 (double) is explicitly converted to int using (int)
        ...
        System.out.println("Second number (double): " + number2);
        System.out.println("Result of addition: " + result);
        
        // Demonstrating explicit type conversion
        double convertedResult = (int)result; // By using brackets, we can force the conversion to int
        ...
        System.out.println("\nThis happens because an int can only store values from -2^31 to 2^31-1.");
        System.out.println("When we try to store a value outside this range, it overflows.");
    }
}
